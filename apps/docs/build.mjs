...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'radio', label: 'Radio Group', icon: 'ti-circle-dot', href: 'radio.html' },
      { key: 'select', label: 'Select', icon: 'ti-selector', href: 'select.html' },
      ...
      { key: 'toggle', label: 'Toggle', icon: 'ti-toggle-left', href: 'toggle.html' },
    ],
  },
];
